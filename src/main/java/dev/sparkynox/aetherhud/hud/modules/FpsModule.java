...
public class FpsModule extends HudModule {
    public FpsModule(float x, float y) { super("fps", x, y); }
    ...
    public void render(DrawContext ctx, float tickDelta) {
        ...
        AetherDraw.drawIconFeather(ctx, 5, 5, AetherDraw.PURPLE);
        AetherDraw.drawLabelValue(ctx, font, "FPS", String.valueOf(fps), 16, 2);
    }
